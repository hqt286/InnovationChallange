...
class InspectionApp extends StatefulWidget {
  ...
  InspectionApp() {
    ...
    _curbAppeal.photos.add(new PhotoDTO(
        1,
        NetworkImage("https://picsum.photos/id/${Random().nextInt(100)}/500"),
  ...
  void commentButtonPressed() {
    setState(() {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => CommentPage(widget._curbAppeal.comment)));
    });
  }
  ...
  void galleryButtonPressed() {
    setState(() {
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => Gallery(widget._curbAppeal.photos)));
    });
  }
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Ink(
                        child: IconButton(
                          icon: Icon(
                            IconData(61707, fontFamily: "MaterialIcons"),
                            size: 25.0,
                          ),
                          color: Colors.black,
                          onPressed: () {},
